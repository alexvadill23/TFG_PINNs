...
# Gráfica de comparación de funciones con puntos de entrenamiento y PDE
...
# Dibujar los puntos de entrenamiento en y=0
x_train_np = x_train.detach().numpy()
ax.scatter(x_train_np, np.zeros_like(x_train_np), color='red', marker='s', 
           s=50, label='Puntos de entrenamiento', zorder=6, edgecolors='darkred')
...
plt.savefig('comparacion_funciones_completa.png', dpi=300, bbox_inches='tight')
plt.close()
