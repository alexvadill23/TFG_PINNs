...
def train_adap(
    ...
    puntos_por_refinamiento = 20
    frecuencia_refinamiento = 500
    ...
    while True:
        ...
        # Refinamiento adaptativo: añade puntos donde el residuo es mayor
        with torch.no_grad():
            x_dense = torch.linspace(-L, L, 2000, device=device).view(-1, 1)
